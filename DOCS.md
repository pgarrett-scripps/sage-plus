...
```shell
$ docker pull ghcr.io/pgarrett-scripps/sage-plus:v0.1.0-beta.2
$ docker run -it --rm -v ${PWD}:/data ghcr.io/pgarrett-scripps/sage-plus:v0.1.0-beta.2 sage -o /data /data/config.json
