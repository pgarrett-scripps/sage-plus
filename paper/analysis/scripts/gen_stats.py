...
from _large_db import LARGE_DB_INPUTS, add_large_db_stats
...
def main():
    ...
    return stats.write(inputs=INPUTS + REPORT_INPUTS + MATCHED_INPUTS + MASS_OFFSET_INPUTS + LARGE_DB_INPUTS + ['analysis/data/execution.json', 'analysis/data/named-modifications.json'])
