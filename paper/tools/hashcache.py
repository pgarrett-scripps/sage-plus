...
def sha(p: Path) -> str:
    ...
    try:
        ...
        # The manuscript contract uses root-relative inputs and pins. Bypass the
        # cache for external temporary files, whose contents can change twice
        # inside one filesystem timestamp tick during the structural tests.
        h = hashlib.sha256()
